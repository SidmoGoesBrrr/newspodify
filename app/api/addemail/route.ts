        ...
        const response = await axios.post(
            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                ...
                <main style="padding: 20px;">
                    ...
                    <p>Could you take a moment to fill out this <a href="https://newspodify.com/suggestions/" style="color: #4CAF50; text-decoration: none;">form</a>? Alternatively, you can reply to this email with your answers to these questions:</p>
                    <ul>
